...
function connectFCS() {
  ...
  ws.on('close', (code, reason) => {
    ...
    console.warn('[FCS] closed code=%d reason="%s" reconnects=%d nextIn=%ds', code, why, fcsReconn, (d/1000).toFixed(1));
    if (code === 4001 || code === 4003) console.warn('[FCS] ⚠️  Auth error — check FCS_API_KEY in Render env vars!');
    if (code === 4002) console.warn('[FCS] ⚠️  Plan limit — XAG/USDINR may need Pro plan on fcsapi.com');
